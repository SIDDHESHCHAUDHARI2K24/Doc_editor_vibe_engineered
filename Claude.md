# Claude.md — Collaborative Document Editor
...
- **OpenCode** is the primary orchestrator (Claude Code is not in use)
- Use `executing-plans` Superpowers skill for task dispatch
